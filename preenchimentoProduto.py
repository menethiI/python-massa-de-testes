...
def gerarlistaCadastroCamposObrigatorios():
    listaCadastroObrigatorio = [ '00', "Ativo", generate_codigoProduto(), generate_nomeProduto(), generate_codigoBarras(), generate_precoVenda(), generate_marca(), generate_pesoLiquido(), generate_pesoBruto(), generate_unidadeMedida()]
    return listaCadastroObrigatorio

planilha = openpyxl.load_workbook('importar-produto.xlsx')
...
planilha.save('importar-produtos-teste.xlsx')
